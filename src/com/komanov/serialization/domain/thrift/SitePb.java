...
public class SitePb implements org.apache.thrift.TBase<SitePb, SitePb._Fields>, java.io.Serializable, Cloneable, Comparable<SitePb> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SitePbStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SitePbTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<SiteFlagPb> flags; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String name; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String description; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<DomainPb> domains; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<MetaTagPb> defaultMetaTags; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<PagePb> pages; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<EntryPointPb> entryPoints; // optional
  ...
  public SitePb(SitePb other) {
    ...
    if (other.isSetFlags()) {
      java.util.List<SiteFlagPb> __this__flags = new java.util.ArrayList<SiteFlagPb>(other.flags.size());
    ...
    if (other.isSetDomains()) {
      java.util.List<DomainPb> __this__domains = new java.util.ArrayList<DomainPb>(other.domains.size());
    ...
    if (other.isSetDefaultMetaTags()) {
      java.util.List<MetaTagPb> __this__defaultMetaTags = new java.util.ArrayList<MetaTagPb>(other.defaultMetaTags.size());
    ...
    if (other.isSetPages()) {
      java.util.List<PagePb> __this__pages = new java.util.ArrayList<PagePb>(other.pages.size());
    ...
    if (other.isSetEntryPoints()) {
      java.util.List<EntryPointPb> __this__entryPoints = new java.util.ArrayList<EntryPointPb>(other.entryPoints.size());
  ...
  public SitePb setId(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer id) {
  ...
  public SitePb setOwnerId(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer ownerId) {
   ...
   * @see SiteTypePb
   */
  public SitePb setSiteType(@org.apache.thrift.annotation.Nullable SiteTypePb siteType) {
  ...
  public void addToFlags(SiteFlagPb elem) {
    if (this.flags == null) {
      this.flags = new java.util.ArrayList<SiteFlagPb>();
    }
    this.flags.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<SiteFlagPb> getFlags() {
    return this.flags;
  }

  public SitePb setFlags(@org.apache.thrift.annotation.Nullable java.util.List<SiteFlagPb> flags) {
    this.flags = flags;
    return this;
  }
  ...
  public SitePb setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public SitePb setDescription(@org.apache.thrift.annotation.Nullable java.lang.String description) {
  ...
  public void addToDomains(DomainPb elem) {
    if (this.domains == null) {
      this.domains = new java.util.ArrayList<DomainPb>();
    }
    this.domains.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<DomainPb> getDomains() {
    return this.domains;
  }

  public SitePb setDomains(@org.apache.thrift.annotation.Nullable java.util.List<DomainPb> domains) {
  ...
  public void addToDefaultMetaTags(MetaTagPb elem) {
    if (this.defaultMetaTags == null) {
      this.defaultMetaTags = new java.util.ArrayList<MetaTagPb>();
    }
    this.defaultMetaTags.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<MetaTagPb> getDefaultMetaTags() {
    return this.defaultMetaTags;
  }

  public SitePb setDefaultMetaTags(@org.apache.thrift.annotation.Nullable java.util.List<MetaTagPb> defaultMetaTags) {
  ...
  public void addToPages(PagePb elem) {
    if (this.pages == null) {
      this.pages = new java.util.ArrayList<PagePb>();
    }
    this.pages.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<PagePb> getPages() {
    return this.pages;
  }

  public SitePb setPages(@org.apache.thrift.annotation.Nullable java.util.List<PagePb> pages) {
    this.pages = pages;
    return this;
  }
  ...
  public void addToEntryPoints(EntryPointPb elem) {
    if (this.entryPoints == null) {
      this.entryPoints = new java.util.ArrayList<EntryPointPb>();
    }
    this.entryPoints.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<EntryPointPb> getEntryPoints() {
    return this.entryPoints;
  }

  public SitePb setEntryPoints(@org.apache.thrift.annotation.Nullable java.util.List<EntryPointPb> entryPoints) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FLAGS:
      if (value == null) {
        ...
        setFlags((java.util.List<SiteFlagPb>)value);
      }
      break;
    ...
    case DOMAINS:
      if (value == null) {
        ...
        setDomains((java.util.List<DomainPb>)value);
      }
      break;
    ...
    case DEFAULT_META_TAGS:
      if (value == null) {
        ...
        setDefaultMetaTags((java.util.List<MetaTagPb>)value);
      }
      break;
    ...
    case PAGES:
      if (value == null) {
        ...
        setPages((java.util.List<PagePb>)value);
      }
      break;
    ...
    case ENTRY_POINTS:
      if (value == null) {
        ...
        setEntryPoints((java.util.List<EntryPointPb>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetDefaultMetaTags()) ? 131071 : 524287);
    if (isSetDefaultMetaTags())
      hashCode = hashCode * 8191 + defaultMetaTags.hashCode();

    hashCode = hashCode * 8191 + ((isSetPages()) ? 131071 : 524287);
    if (isSetPages())
      hashCode = hashCode * 8191 + pages.hashCode();

    hashCode = hashCode * 8191 + ((isSetEntryPoints()) ? 131071 : 524287);
    if (isSetEntryPoints())
      hashCode = hashCode * 8191 + entryPoints.hashCode();
  ...
  public int compareTo(SitePb other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDefaultMetaTags(), other.isSetDefaultMetaTags());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDefaultMetaTags()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPages(), other.isSetPages());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPages()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEntryPoints(), other.isSetEntryPoints());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEntryPoints()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPublished(), other.isSetPublished());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPublished()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SitePb(");
    boolean first = true;
  ...
  private static class SitePbStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SitePbStandardScheme getScheme() {
      return new SitePbStandardScheme();
    }
  }

  private static class SitePbStandardScheme extends org.apache.thrift.scheme.StandardScheme<SitePb> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.flags = new java.util.ArrayList<SiteFlagPb>(_list16.size);
                @org.apache.thrift.annotation.Nullable SiteFlagPb _elem17;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.domains = new java.util.ArrayList<DomainPb>(_list19.size);
                @org.apache.thrift.annotation.Nullable DomainPb _elem20;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.defaultMetaTags = new java.util.ArrayList<MetaTagPb>(_list22.size);
                @org.apache.thrift.annotation.Nullable MetaTagPb _elem23;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.pages = new java.util.ArrayList<PagePb>(_list25.size);
                @org.apache.thrift.annotation.Nullable PagePb _elem26;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.entryPoints = new java.util.ArrayList<EntryPointPb>(_list28.size);
                @org.apache.thrift.annotation.Nullable EntryPointPb _elem29;
  ...
  private static class SitePbTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SitePbTupleScheme getScheme() {
      return new SitePbTupleScheme();
    }
  }

  private static class SitePbTupleScheme extends org.apache.thrift.scheme.TupleScheme<SitePb> {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.flags = new java.util.ArrayList<SiteFlagPb>(_list41.size);
          @org.apache.thrift.annotation.Nullable SiteFlagPb _elem42;
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.domains = new java.util.ArrayList<DomainPb>(_list44.size);
          @org.apache.thrift.annotation.Nullable DomainPb _elem45;
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.defaultMetaTags = new java.util.ArrayList<MetaTagPb>(_list47.size);
          @org.apache.thrift.annotation.Nullable MetaTagPb _elem48;
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.pages = new java.util.ArrayList<PagePb>(_list50.size);
          @org.apache.thrift.annotation.Nullable PagePb _elem51;
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.entryPoints = new java.util.ArrayList<EntryPointPb>(_list53.size);
          @org.apache.thrift.annotation.Nullable EntryPointPb _elem54;
