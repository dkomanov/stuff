...
public class SiteEventDataPb implements org.apache.thrift.TBase<SiteEventDataPb, SiteEventDataPb._Fields>, java.io.Serializable, Cloneable, Comparable<SiteEventDataPb> {
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new SiteEventDataPbStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new SiteEventDataPbTupleSchemeFactory();

  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer id; // optional
  public @org.apache.thrift.annotation.Nullable SiteEventPb ev; // optional
  ...
  public SiteEventDataPb setId(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer id) {
  ...
  public SiteEventDataPb setEv(@org.apache.thrift.annotation.Nullable SiteEventPb ev) {
    this.ev = ev;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetEv()) ? 131071 : 524287);
    if (isSetEv())
      hashCode = hashCode * 8191 + ev.hashCode();
  ...
  public int compareTo(SiteEventDataPb other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetEv(), other.isSetEv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEv()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("SiteEventDataPb(");
    boolean first = true;
  ...
  private static class SiteEventDataPbStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SiteEventDataPbStandardScheme getScheme() {
      return new SiteEventDataPbStandardScheme();
    }
  }

  private static class SiteEventDataPbStandardScheme extends org.apache.thrift.scheme.StandardScheme<SiteEventDataPb> {
  ...
  private static class SiteEventDataPbTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public SiteEventDataPbTupleScheme getScheme() {
      return new SiteEventDataPbTupleScheme();
    }
  }

  private static class SiteEventDataPbTupleScheme extends org.apache.thrift.scheme.TupleScheme<SiteEventDataPb> {
