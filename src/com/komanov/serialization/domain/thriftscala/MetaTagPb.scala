...
object MetaTagPb extends ThriftStructCodec3[MetaTagPb] {
  private val NoPassthroughFields = immutable$Map.empty[Short, TFieldBlob]
  val Struct = new TStruct("MetaTagPb")
   ...
   */
  def validate(_item: MetaTagPb): Unit = {
  }

  def withoutPassthroughFields(original: MetaTagPb): MetaTagPb =
    new Immutable(
      name =
        {
  ...
  override def encode(_item: MetaTagPb, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }

  private[this] def lazyDecode(_iprot: LazyTProtocol): MetaTagPb = {
  ...
  override def decode(_iprot: TProtocol): MetaTagPb =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[this] def eagerDecode(_iprot: TProtocol): MetaTagPb = {
  ...
  def unapply(_item: MetaTagPb): _root_.scala.Option[scala.Product2[Option[String], Option[String]]] = _root_.scala.Some(_item)
  ...
  object Immutable extends ThriftStructCodec3[MetaTagPb] {
    override def encode(_item: MetaTagPb, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): MetaTagPb = MetaTagPb.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[MetaTagPb] = MetaTagPb.metaData
  }

  /**
   * The default read-only implementation of MetaTagPb.  You typically should not need to
   * directly reference this class; instead, use the MetaTagPb.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the MetaTagPb trait with additional state or
   * behavior and implement the read-only methods from MetaTagPb using an underlying
   * instance.
   */
  trait Proxy extends MetaTagPb {
    protected def _underlying_MetaTagPb: MetaTagPb
    override def name: _root_.scala.Option[String] = _underlying_MetaTagPb.name
    override def value: _root_.scala.Option[String] = _underlying_MetaTagPb.value
    override def _passthroughFields = _underlying_MetaTagPb._passthroughFields
  }
}
  ...
  with java.io.Serializable
{
          ...
          _fieldId match {
            case 1 =>
              if (name.isDefined) {
                ...
                _root_.scala.Some(MetaTagPb.NameField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (value.isDefined) {
                ...
                _root_.scala.Some(MetaTagPb.ValueField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): MetaTagPb = {
   ...
   */
  def unsetField(_fieldId: Short): MetaTagPb = {
    var name: _root_.scala.Option[String] = this.name
    var value: _root_.scala.Option[String] = this.value
   ...
   * from the passthroughFields map, if present.
   */
  def unsetName: MetaTagPb = unsetField(1)

  def unsetValue: MetaTagPb = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    MetaTagPb.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[MetaTagPb]

  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _root_.scala.runtime.ScalaRunTime._equals(this, other) &&
      _passthroughFields == other.asInstanceOf[MetaTagPb]._passthroughFields
  ...
  override def productPrefix: String = "MetaTagPb"
}