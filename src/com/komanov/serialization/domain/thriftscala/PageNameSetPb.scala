...
object PageNameSetPb extends ThriftStructCodec3[PageNameSetPb] {
  private val NoPassthroughFields = immutable$Map.empty[Short, TFieldBlob]
  val Struct = new TStruct("PageNameSetPb")
   ...
   */
  def validate(_item: PageNameSetPb): Unit = {
  }

  def withoutPassthroughFields(original: PageNameSetPb): PageNameSetPb =
    new Immutable(
      path =
        {
  ...
  override def encode(_item: PageNameSetPb, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }

  private[this] def lazyDecode(_iprot: LazyTProtocol): PageNameSetPb = {
  ...
  override def decode(_iprot: TProtocol): PageNameSetPb =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[this] def eagerDecode(_iprot: TProtocol): PageNameSetPb = {
  ...
  def unapply(_item: PageNameSetPb): _root_.scala.Option[scala.Product2[Option[String], Option[String]]] = _root_.scala.Some(_item)
  ...
  object Immutable extends ThriftStructCodec3[PageNameSetPb] {
    override def encode(_item: PageNameSetPb, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): PageNameSetPb = PageNameSetPb.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[PageNameSetPb] = PageNameSetPb.metaData
  }

  /**
   * The default read-only implementation of PageNameSetPb.  You typically should not need to
   * directly reference this class; instead, use the PageNameSetPb.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the PageNameSetPb trait with additional state or
   * behavior and implement the read-only methods from PageNameSetPb using an underlying
   * instance.
   */
  trait Proxy extends PageNameSetPb {
    protected def _underlying_PageNameSetPb: PageNameSetPb
    override def path: _root_.scala.Option[String] = _underlying_PageNameSetPb.path
    override def name: _root_.scala.Option[String] = _underlying_PageNameSetPb.name
    override def _passthroughFields = _underlying_PageNameSetPb._passthroughFields
  }
}
  ...
  with java.io.Serializable
{
          ...
          _fieldId match {
            case 1 =>
              if (path.isDefined) {
                ...
                _root_.scala.Some(PageNameSetPb.PathField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (name.isDefined) {
                ...
                _root_.scala.Some(PageNameSetPb.NameField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): PageNameSetPb = {
   ...
   */
  def unsetField(_fieldId: Short): PageNameSetPb = {
    var path: _root_.scala.Option[String] = this.path
    var name: _root_.scala.Option[String] = this.name
   ...
   * from the passthroughFields map, if present.
   */
  def unsetPath: PageNameSetPb = unsetField(1)

  def unsetName: PageNameSetPb = unsetField(2)


  override def write(_oprot: TProtocol): Unit = {
    PageNameSetPb.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[PageNameSetPb]

  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _root_.scala.runtime.ScalaRunTime._equals(this, other) &&
      _passthroughFields == other.asInstanceOf[PageNameSetPb]._passthroughFields
  ...
  override def productPrefix: String = "PageNameSetPb"
}