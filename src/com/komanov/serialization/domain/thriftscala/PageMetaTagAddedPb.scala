...
object PageMetaTagAddedPb extends ThriftStructCodec3[PageMetaTagAddedPb] {
  private val NoPassthroughFields = immutable$Map.empty[Short, TFieldBlob]
  val Struct = new TStruct("PageMetaTagAddedPb")
   ...
   */
  def validate(_item: PageMetaTagAddedPb): Unit = {
  }

  def withoutPassthroughFields(original: PageMetaTagAddedPb): PageMetaTagAddedPb =
    new Immutable(
      path =
        {
  ...
  override def encode(_item: PageMetaTagAddedPb, _oproto: TProtocol): Unit = {
    _item.write(_oproto)
  }

  private[this] def lazyDecode(_iprot: LazyTProtocol): PageMetaTagAddedPb = {
  ...
  override def decode(_iprot: TProtocol): PageMetaTagAddedPb =
    _iprot match {
      case i: LazyTProtocol => lazyDecode(i)
      case i => eagerDecode(i)
    }

  private[this] def eagerDecode(_iprot: TProtocol): PageMetaTagAddedPb = {
  ...
  def unapply(_item: PageMetaTagAddedPb): _root_.scala.Option[scala.Product3[Option[String], Option[String], Option[String]]] = _root_.scala.Some(_item)
  ...
  object Immutable extends ThriftStructCodec3[PageMetaTagAddedPb] {
    override def encode(_item: PageMetaTagAddedPb, _oproto: TProtocol): Unit = { _item.write(_oproto) }
    override def decode(_iprot: TProtocol): PageMetaTagAddedPb = PageMetaTagAddedPb.decode(_iprot)
    override lazy val metaData: ThriftStructMetaData[PageMetaTagAddedPb] = PageMetaTagAddedPb.metaData
  }

  /**
   * The default read-only implementation of PageMetaTagAddedPb.  You typically should not need to
   * directly reference this class; instead, use the PageMetaTagAddedPb.apply method to construct
   * new instances.
   */
  class Immutable(
  ...
  /**
   * This Proxy trait allows you to extend the PageMetaTagAddedPb trait with additional state or
   * behavior and implement the read-only methods from PageMetaTagAddedPb using an underlying
   * instance.
   */
  trait Proxy extends PageMetaTagAddedPb {
    protected def _underlying_PageMetaTagAddedPb: PageMetaTagAddedPb
    override def path: _root_.scala.Option[String] = _underlying_PageMetaTagAddedPb.path
    override def name: _root_.scala.Option[String] = _underlying_PageMetaTagAddedPb.name
    override def value: _root_.scala.Option[String] = _underlying_PageMetaTagAddedPb.value
    override def _passthroughFields = _underlying_PageMetaTagAddedPb._passthroughFields
  }
}

trait PageMetaTagAddedPb
  extends ThriftStruct
  with scala.Product3[Option[String], Option[String], Option[String]]
  with java.io.Serializable
{
  import PageMetaTagAddedPb._
          ...
          _fieldId match {
            case 1 =>
              if (path.isDefined) {
                ...
                _root_.scala.Some(PageMetaTagAddedPb.PathField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (name.isDefined) {
                ...
                _root_.scala.Some(PageMetaTagAddedPb.NameField)
              } else {
                _root_.scala.None
              }
            case 3 =>
              if (value.isDefined) {
                ...
                _root_.scala.Some(PageMetaTagAddedPb.ValueField)
              } else {
                _root_.scala.None
              }
   ...
   * _passthroughFields.
   */
  def setField(_blob: TFieldBlob): PageMetaTagAddedPb = {
   ...
   */
  def unsetField(_fieldId: Short): PageMetaTagAddedPb = {
    var path: _root_.scala.Option[String] = this.path
    var name: _root_.scala.Option[String] = this.name
    var value: _root_.scala.Option[String] = this.value
   ...
   * from the passthroughFields map, if present.
   */
  def unsetPath: PageMetaTagAddedPb = unsetField(1)

  def unsetName: PageMetaTagAddedPb = unsetField(2)

  def unsetValue: PageMetaTagAddedPb = unsetField(3)


  override def write(_oprot: TProtocol): Unit = {
    PageMetaTagAddedPb.validate(this)
  ...
  override def canEqual(other: Any): Boolean = other.isInstanceOf[PageMetaTagAddedPb]

  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _root_.scala.runtime.ScalaRunTime._equals(this, other) &&
      _passthroughFields == other.asInstanceOf[PageMetaTagAddedPb]._passthroughFields
  ...
  override def productPrefix: String = "PageMetaTagAddedPb"
}