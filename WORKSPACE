...
scala_version = "%s.8" % scala_major_version
...
specs2_junit_repositories(scala_version = scala_version)
...
twitter_scrooge(scala_version = scala_version)
...
maven_install(
    artifacts = [
        "org.specs2:specs2-mock_%s:4.6.0" % scala_major_version,
...
maven_install(
    ...
    artifacts = [
        ...
        "com.fasterxml.jackson.module:jackson-module-scala_%s:2.9.5" % scala_major_version,
        "io.suzaku:boopickle_%s:1.3.0" % scala_major_version,
        "com.twitter:chill_%s:0.9.2" % scala_major_version,
        "org.apache.thrift:libthrift:0.10.0",
        "io.circe:circe-core_%s:0.9.3" % scala_major_version,
        "io.circe:circe-generic_%s:0.9.3" % scala_major_version,
        "io.circe:circe-parser_%s:0.9.3" % scala_major_version,
        "com.github.plokhotnyuk.jsoniter-scala:jsoniter-scala-macros_%s:0.52.2" % scala_major_version,
